...
echo -e " [\e[36m•4\e[0m] Information Script"
echo -e " [\e[36m•5\e[0m] Generate cert ssl"
echo -e " [\e[36m•6\e[0m] Check CPU & RAM"
echo -e " [\e[36m•7\e[0m] Cek Service VPN in VPS"
echo -e " [\e[36m•8\e[0m] Backup VPS"
echo -e " [\e[36m•9\e[0m] Restore VPS"
echo -e ""
